<x-modal modalId="modalSupplier" modalTitle="Proveedores" modalSize="modal-lg">
    <form wire:submit={{ $Id == 0 ? 'storeSupplier' : "updateSupplier($Id)" }}>
        <div class="form-row">
            ...
            <div class="form-group col-12">
                ...
                <input wire:model.defer="name" type="text" class="form-control" placeholder="Nombre del proveedor" id="name">
                @error('name')
                    <div class="alert bg-danger text-white bold text-center w-100 mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group col-12">
                ...
                <input wire:model.defer="address" type="text" class="form-control" placeholder="Dirección del proveedor" id="address">
                @error('address')
                    <div class="alert bg-danger text-white bold text-center w-100 mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group col-6">
                ...
                <input wire:model.defer="phone" type="text" class="form-control" placeholder="Número de teléfono" id="phone">
                @error('phone')
                    <div class="alert bg-danger text-white bold text-center w-100 mt-1">{{ $message }}</div>
                @enderror
            </div>
